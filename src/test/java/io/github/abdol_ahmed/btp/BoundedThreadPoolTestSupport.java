...
public class BoundedThreadPoolTestSupport {
    ...
    /**
     * Creates a pair of latches for controlling task execution.
     * The started latch is counted down when the task begins.
     * The finish latch blocks the task until counted down.
     */
    ...
    /**
     * Creates a task that waits on finishLatch before completing,
     * and counts down startedLatch when it begins.
     */
    ...
    /**
     * Ensures pool shutdown and waits for termination.
     * Returns true if all workers terminated within timeout.
     */
