...
public class GracefulShutdownTest {
    ...
    void testShutdownDrainsAllTasks() throws InterruptedException {
        ...
        assertTrue(allTasksDone.await(5, TimeUnit.SECONDS), 
                  "Not all tasks completed after shutdown");
        
        // Verify all tasks were executed
        assertEquals(TASK_COUNT, completedTasks.get(), 
                    "Some tasks were lost during shutdown");
    }
    ...
    void testShutdownNowInterruptsTasks() throws InterruptedException {
        ...
        assertTrue(interruptedTasks.get() > 0, 
                  "No tasks were interrupted by shutdownNow");
        
        // Some tasks should be returned unexecuted
        assertTrue(unexecuted.size() > 0, 
                  "No unexecuted tasks returned by shutdownNow");
    }
}
